...
function CaptureAudio({hide}) {
  ...
  return (
    <div className="flex text-2xl w-full justify-end items-center">
      ...
      <div className="mx-4 py-2 px-4 text-white text-lg flex gap-3 justify-center items-cente bg-search-input-container-background rounded-full drop-shadow-lg">
        {isRecording ? (
