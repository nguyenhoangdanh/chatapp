  ...
  return (
    ...
    <div className="flex items-center justify-center">
      ...
      }
      {
        type === "xl" && (
         ...
         >
          <div className={`z-10 bg-photopicker-overlay-background h-60 w-60 absolute top-0 left-0 items-center rounded-full justify-center flex-col text-center gap-2
    ...
    {isContextMenuVisible && (
      ...
      {showPhotoLibrary&& <PhotoLibrary
       setImage={setImage}
       hidePhotoLibrary={setShowPhotoLibrary}></PhotoLibrary> }
